...
namespace TheArtOfDev.HtmlRenderer.XamarinForms
{
    ...
    /// </para>
    /// </summary>
    public class HtmlLabel : SkiaSharp.Views.Forms.SKCanvasView //Xamarin.Forms.View
    {
        ...
        void OnCanvasViewPaintSurface(object sender, SKPaintSurfaceEventArgs args)
        {
            ...
            _htmlContainer.MaxSize = MaximumSize;
            _htmlContainer.PerformLayout(_canvas);
            _htmlContainer.PerformPaint(_canvas);
            return;

            string str = _text;// "Hello SkiaSharp!";
            ...
            // And draw the text
            _canvas.DrawText(str, xText, yText, textPaint);
            ...
            // Draw one frame
            _canvas.DrawRoundRect(frameRect, 20, 20, framePaint);

            // Inflate the frameRect and draw another
            frameRect.Inflate(10, 10);
            framePaint.Color = SKColors.DarkBlue;
            _canvas.DrawRoundRect(frameRect, 30, 30, framePaint);
        }

        public SKTypeface Typeface
        {
            get { return HtmlContainer.DefaultTypeface; }
            set
            {
                HtmlContainer.DefaultTypeface = value;
            }
        }
        ...
        public RSize MaximumSize
        {
            get { return _htmlContainer.MaxSize; }
            set
            {
