...
using TheArtOfDev.HtmlRenderer.XamarinForms.Adapters;
...
namespace TheArtOfDev.HtmlRenderer.XamarinForms
{
    ...
    public static class HtmlRender
    {
        ...
        //    MonoAdapter.Instance.AddFontFamily(new FontFamilyAdapter(fontFamily));
        //}
        ...
        public static void AddFontFamilyMapping(string fromFamily, string toFamily)
        {
            ...
            MonoAdapter.Instance.AddFontFamilyMapping(fromFamily, toFamily);
        }
        ...
        {
            return CssData.Parse(MonoAdapter.Instance, stylesheet, combineWithDefault);
        }
