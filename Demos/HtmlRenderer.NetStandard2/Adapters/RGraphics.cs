...
namespace TheArtOfDev.HtmlRenderer.Adapters
{
    ...
    public abstract class RGraphics : IDisposable
    {
        ...
        public abstract RSize MeasureString(string str, RFont font, RFontStyle style);
        ...
        public abstract void DrawString(String str, RFont font, RColor color, RPoint point, RSize size, bool rtl, RFontStyle style);
